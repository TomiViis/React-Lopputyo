...
import LuontiScreen5 from "./LuontiScreen5";
...
const ListaScreen: FC<Props> = ({
    ...
    const haeLista = async () => {
        try {
            const response = await fetch("/foorumi5");
    ...
    return (
        ...
        <Stack  fontFamily={"Roboto"} display={"inline-block"} border={"5px solid black"} width={"960px"} marginTop={"2px"} style={{backgroundColor: "white"}} textAlign={"center"}>
            <h1>Tervetuloa osto- ja myynti sivulle</h1>
            ...
            <Lista>
                ...
                <LuontiScreen5 viestiLista5={[]} setViestiLista={function (lista: Viesti[]): void {} }/>
                </Stack>
