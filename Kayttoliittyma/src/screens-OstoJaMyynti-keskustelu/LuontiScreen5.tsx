...
const LuontiScreen: FC<Props> = ({
    ...
    */
    /*const kasitteleLuonti = () => {
        ...
        const onDuplikaatti = viestiLista.find(asia => asia.otsikko === uusiOtsikko);
        if (onDuplikaatti) {
            alert("Yritä keksiä uniikki otsikko.");
        } else {
            const uusiLista = [...viestiLista];
            const uusiAsia: TodoAsia = {id: uuid(), otsikko: uusiOtsikko, tila: "Tekemättä"}
