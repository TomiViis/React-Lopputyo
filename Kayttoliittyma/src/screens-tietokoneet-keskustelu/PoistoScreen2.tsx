   ...
   */
    ...
    return (
        <>
            ...
            <Button style={{scale: "1", width: "200px", marginLeft: "10px", marginBottom: "10px", border: "4px solid black"}} variant="contained" color="error" onClick={() => navigoi("/kategoriat/tietokoneet")}>Peruuta</Button>
        </Stack>
        </>
    )
}
