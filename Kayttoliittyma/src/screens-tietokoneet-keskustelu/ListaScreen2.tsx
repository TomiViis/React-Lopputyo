...
import LuontiScreen2 from "./LuontiScreen2";
...
const ListaScreen: FC<Props> = ({
    ...
    const haeLista = async () => {
        try {
            const response = await fetch("/foorumi2");
    ...
    return (
        ...
        <Stack  fontFamily={"Roboto"} display={"inline-block"} border={"5px solid black"} width={"960px"} marginTop={"2px"} style={{backgroundColor: "white"}} textAlign={"center"}>
            <h1>Tervetuloa tietokoneet keskustelu sivulle</h1>
            ...
            <Lista>
                ...
                <LuontiScreen2 viestiLista2={[]} setViestiLista={function (lista: Viesti[]): void {} }/>
                </Stack>
