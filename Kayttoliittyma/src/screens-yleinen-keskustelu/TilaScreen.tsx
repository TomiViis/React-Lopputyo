import { Highlight, ThumbDown, ThumbUp } from "@mui/icons-material";
...
const TilaScreen: FC<Props> = ({
    ...
    const { id } = useParams();
    const [ uusiTila, setUusiTila ] = useState<string>("Tykkää")
    ...
    return (
        ...
        <Stack style={{border: "5px solid black", backgroundColor: "white", width: "960px", textAlign: "center", alignItems: "center"}}>
            ...
            <Button style={{width: "300px", marginLeft: "10px", marginBottom: "10px", border: "4px solid black"}} variant="contained" color="error" onClick={() => navigoi("/kategoriat/videopelit")}>Peruuta</Button>
        </Stack>
    )
}
