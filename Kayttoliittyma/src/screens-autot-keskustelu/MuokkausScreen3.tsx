...
const MuokkausScreen: FC<Props> = ({
    ...
    const haeMuokattavaAsia = async () => {
        try {
            const response = await fetch(`/foorumi3/${id}`);
    ...
    */
    ...
    return (
        <Stack fontFamily={"Roboto"} style={{border: "5px solid blue", backgroundColor: "white", width: "960px", textAlign: "center", alignItems: "center"}}>
            ...
            <Button  style={{scale: "1", width: "200px", marginLeft: "10px", marginBottom: "10px", border: "4px solid black"}} variant="contained" color="error" onClick={() => navigoi("/kategoriat/autot")}>Peruuta</Button>
