...
const TilaScreen: FC<Props> = ({
    ...
    return (
        <Stack style={{border: "5px solid black", backgroundColor: "white", width: "960px", textAlign: "center", alignItems: "center"}}>
            ...
            <Button style={{width: "300px", marginLeft: "10px", marginBottom: "10px", border: "4px solid black"}} variant="contained" color="error" onClick={() => navigoi("/kategoriat/autot")}>Peruuta</Button>
        </Stack>
    )
}
